export function JusticaWatermark({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      {/* Travessão + pratos — animáveis no hero */}
      <g className="justica-wm-yoke" style={{ transformOrigin: "180px 108px" }}>
        <line
          x1="32"
          y1="108"
          x2="328"
        ...
        <g className="justica-wm-pan justica-wm-pan--left">
        ...
        <g className="justica-wm-pan justica-wm-pan--right">
