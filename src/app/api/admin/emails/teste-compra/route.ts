...
export async function POST(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({
      ...
      ...resultado,
      dica:
        "Confira as caixas do destinatário e financeiro@factoia.com.br, o push ntfy (se NTFY_TOPIC estiver na Vercel) e o log abaixo. Convite só sai se o e-mail ainda não tiver perfil.",
    });
  } catch (erro) {
