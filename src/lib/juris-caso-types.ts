...
export function montarBlocoPromptJurisCaso(
  ...
  return [
    ...
    "2) Cite no padrão forense: [[JURIS]]tribunal/classe/nº + EMENTA INTEGRAL ipsis litteris[[/JURIS]].",
    "   Interpretação e cabimento ao caso = parágrafo NORMAL fora do [[JURIS]] — sem alterar a ementa citada.",
