...
const TABELA: Record<string, AreaRitoCopy> = {
  ...
  consumidor: {
    ...
    ritoLinha:
      "Atue na justiça comum brasileira em demanda de consumo (CDC + CPC). NÃO aplique Lei 9.099/95, teto do Juizado, recurso inominado nem Turma Recursal. Honorários: art. 85 do CPC. Agravo de instrumento: endereçamento ao Tribunal, não à vara. Use CDC quando o fato autorizar e os NOMES LITERAIS das partes dos FATOS — nunca substitua o polo por “instituição financeira”. Não invente CEP, CNPJ, sede, multa diária nem SISBAJUD se isso não estiver nos FATOS.",
