...
export function montarSystemPromptAnaliseEstrategica(
  ...
  return [
    ...
    "8. Súmulas/artigos-chave pertinentes (só se realmente aplicáveis);",
...
export function montarSystemPromptRedacaoTier1(
  ...
  return [
    ...
    "Se houver <PLANO_DE_TOPICOS_OBRIGATORIO> na estratégia, use EXATAMENTE esses títulos romanos e subtítulos — redija o conteúdo, não troque os nomes por genéricos.",
    ...
    "",
    "5) LEGISLAÇÃO — CITE SEM TRANSCRIÇÃO:",
    "   - Cite artigo/inciso/parágrafo pertinentes (ex.: art. 14 do CDC; art. 300 do CPC) e subsuma aos fatos.",
