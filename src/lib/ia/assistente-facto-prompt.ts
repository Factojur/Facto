...
function blocoBaseMunicipalEJuris(
  ...
  return [
    ...
    "Use só o lastro abaixo. Em [[JURIS]]: ementa/enunciado INTEGRAL e ipsis litteris (sem resumir).",
    "Interpretação e cabimento = texto normal FORA de [[JURIS]].",
    "Tribunal estadual: só o TJ da UF do foro; superiores/regionais (STF/STJ/TST/TSE/TRF/TRT) quando couberem — nunca TJ de outro Estado.",
    contextoBase ||
...
export function montarSystemPromptRedacaoTier1(
  ...
  return [
    ...
    "   - SÚMULA (estrito teor): cite o ENUNCIADO LITERAL COMPLETO em bloco próprio (sem cortar nem resumir):",
    ...
    "   - JURISPRUDÊNCIA (estrito teor): EMENTA/TESE LITERAL E INTEGRAL da <BASE_DE_CONHECIMENTO> ou <JURISPRUDENCIA_DO_CASO> em:",
    "     [[JURIS]]Tribunal, classe/nº, ementa completa…[[/JURIS]]",
    "     PROIBIDO resumir, truncar, reescrever ou \"adaptar\" a ementa dentro do [[JURIS]] — só o texto ipsis litteris da base.",
    ...
    "   - FORO / TRIBUNAL DO LASTRO: cite só julgados do TJ do Estado da comarca (UF do foro) OU de tribunais superiores/regionais",
    "     cabíveis (STF, STJ, TST, TSE, TRF, TRT). PROIBIDO citar TJ de outro Estado (ex.: peça em SP com ementa do TJMG).",
    ...
    "Epígrafe: em peças que tramitam em autos já existentes, inclua Processo nº quando o número",
    "constar no dossiê — não invente número CNJ. Polos na epígrafe conforme a espécie",
    "(Autor/Réu; Apelante/Apelado; Agravante/Agravado; Impetrante/Paciente ou Impetrado;",
    "Querelante/Querelado; Acusado/Ministério Público; Representante/Representado etc.).",
    "Petições intermediárias curtas (memorial, manifestação, juntada, ciência, informações)",
    "levam só o Processo nº — sem linhas de polos.",
    "Inaugurais: sem bloco Processo nº + polos; endereçamento “DA ___ª VARA …” (não “DE UMA DAS VARAS”).",
    "Nome forense da peça em português (ex.: AÇÃO DE ALIMENTOS), nunca slug (PETICAO-INICIAL).",
    "",
    "================================================================================",
