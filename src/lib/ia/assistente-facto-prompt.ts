...
export function montarSystemPromptRedacaoTier1(
  ...
  return [
    ...
    "   (texto)",
    "",
    "   III - DA TUTELA DE URGÊNCIA (somente se houver)",
    "",
    "   [III ou IV] - DAS PROVAS E ANEXOS",
    ...
    "   c) ...",
    "",
    "   Sem tutela: I Fatos → II Direito → III Provas → IV Pedidos.",
    "   Com tutela: I Fatos → II Direito → III Tutela → IV Provas → V Pedidos.",
