...
export function montarSystemPromptRedacaoTier1(
  ...
  return [
    ...
    "   - Qualificação: NÃO invente estado civil, RG, CEP, CNPJ, sede nem e-mail. Se o fato não trouxer, omita o campo ou use reticências simples (…), nunca \"[Inserir CNPJ]\", \"insubistente\" nem CPF mascarado fictício.",
