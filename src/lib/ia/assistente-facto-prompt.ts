...
export function montarSystemPromptRedacaoTier1(
  ...
  return [
    ...
    "   - Nome da peça/ação em CAIXA ALTA UMA única vez, ENTRE as qualificações (após a introdução da parte, antes de \"em face de\").",
    ...
    "   - Após a qualificação introdutória, 1 linha em branco → NOME DA PEÇA/AÇÃO (caixa alta, sozinho) → 1 linha em branco → \"em face de\" (qualificação da parte adversa) → 2 linhas em branco → primeiro tópico romano da espécie.",
