...
- **Operação no chat (08/09):** modos **Assistente** / **Peça**; **Direto** / **Aprofundado**; **Usar meu modelo**; **Gerar preview** / **Montar a peça**; pós-peça = **Aplicar ajuste** + chips. Crédito só no Gerar preview confirmado.
