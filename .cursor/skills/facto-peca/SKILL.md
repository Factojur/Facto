...
Módulo aberto hoje: **JEC** — **base de desenvolvimento** da dashboard. Contrato compartilhado: `src/lib/minuta-modulo.ts` (`rotuloNav` no menu). Preview admin: Consumidor, Civil, Trabalhista e Família (`available: false`).
