...
- **Redator:** Flash padrão. Claude Sonnet Essencial **10%** / Completo **20%** / Pro **26%** só com **função detalhada aceita** no chat (O5b) + gatilho + `ANTHROPIC_API_KEY`. Trial = Flash. Sem botões Expressa/Equilíbrio/Detalhada no header — pergunta no chat quando o roteador recomenda e há teto.
