...
- **Endereçamento fiel aos autos:** não inventar «Vara Cível»/«Família» se o PDF só traz «1ª VARA»; especialidade só se explícita. Default de `areaJudiciaria` não força mais JEC quando `areaId` está setado.
