...
- **Último ato / peça cabível (0 tokens):** sentença/JULGO de mérito → apelação (JEC→recurso inominado; trabalhista→RO); interlocutória/astreintes → agravo; não confundir “em benefício do núcleo” nem citação de “reclamante” no CC com previdenciário/CLT. Capa `Requerente:`/`Requerido:` prevalece.
- **Sonnet (04/09):** ligado no Redator (Completo 20% / Pro 26%); gatilhos ampliados (área densa + relato 3,5k / Fundo); fallback Flash se Anthropic falhar.
