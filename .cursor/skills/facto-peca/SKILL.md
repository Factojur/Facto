...
- **Citações:** só copy-paste literal da base FACTO em `[[JURIS]]`; interpretação/paráfrase = corpo normal.
...
- **Redator:** Flash padrão. Claude Sonnet Completo **20%** / Pro **26%** com gatilho (espécie complexa, relato longo — áreas densas ≥3,5k —, área densa+Fundo, tutela no Pro, esforço Detalhada) + `ANTHROPIC_API_KEY`. Gemini e Claude compartilham `PERSONA_ADVOGADO_SENIOR_FACTO`.
